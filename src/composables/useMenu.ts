...
export function useMenu() 
{
  ...
  [
    {
      ...new ItemMenu({ label:    "Inicio", icon: "mdi-home-circle", to: "/", visible: true }),
      /* submenu:
      [
        { ...new ItemMenu({
            label:      "Hoja de ruta",
    ...
    {
      ...new ItemMenu({ label: "📖", icon: "mdi-book-open-variant", visible: !usuario.value.externo}),
      submenu:
      [
        { ...new ItemMenu({
    ...
    {
      ...new ItemMenu({ label: "Terceros", icon: "mdi-account-group", to: "/terceros", visible:  !usuario.value.externo }),
      submenu:
      [
        { ...new ItemMenu({
        ...
        { ...new ItemMenu({
                            ...
                            to:         "/crear-cliente",
                            visible:    permisos.value.terceros_crear && !usuario.value.externo
                          }),
        },
        { ...new ItemMenu({
                            ...
                            to:         "/crear-proveedor",
                            visible:    permisos.value.terceros_crear_proveedor && !usuario.value.externo
                          }), 
        },
      ]
    },
    {
      ...new ItemMenu({ label: "Comercial", icon: "mdi-rocket-launch", to: "/comercial", visible:  !usuario.value.externo}),
      submenu:
      [
        { ...new ItemMenu({
                            label:      "Cotizaciones",
        ...
        { ...new ItemMenu({ separator: true, visible: !usuario.value.externo}), },
        { ...new ItemMenu({
                            label:      "Comisiones",
...
/*        
    ...
    {
      ...new ItemMenu({ label: "Logistica", icon: "mdi-truck-fast", to: "/logistica", visible:  true }),
      submenu:
      [
        { ...new ItemMenu({
                            label:      "Pedidos",
        ...
        { ...new ItemMenu({
                            ...
                            icon:       "mdi-store",
                            to:         "/pedidos/tienda",
                            visible:    !(usuario.value.areaEsEscom && usuario.value.esComercial ) && !usuario.value.externo
                          }),
        },         
        { ...new ItemMenu({
                            label:      "Entregas",
        ...
        { ...new ItemMenu({
                            ...
                            icon:       "mdi-domain",
                            to:         "/pedidos/proveedor?estados=4_3_2_1_0&limite=50&offset=0",
                            visible:    permisos.value.terceros_ver
                          }),
        },
        { ...new ItemMenu({
 ...
 */
    {
      ...new ItemMenu({ label: "Productos", icon: "mdi-package-variant-closed", visible:  true }),
      submenu:
      [
        { ...new ItemMenu({
                              label:    "Productos",
        ...
        { ...new ItemMenu({
                              ...
                              to:       "/productos/crear",
                              visible:  ( usuario.value.esProduccion || usuario.value.esGerencia ) && !usuario.value.externo
                          } ),
        },
        { ...new ItemMenu({
                              label:    "Propiedades",
