<script setup lang="ts">
  ...
  {
    tabs.value.alerts[0]  = ( !!b.value.f.buscar            || !!b.value.f.contacto           || ToolDate.fechaValida( b.value.f.desde ) || !!b.value.f.facturado.label  || !!b.value.f.municipioContacto.id ||
                              !!b.value.f.estados.length    || !!b.value.f.condiciones.length || ToolDate.fechaValida( b.value.f.hasta ) || !!b.value.f.usuario          || !!b.value.f.creador              ||
